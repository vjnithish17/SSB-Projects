...
const Bookings = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      const res = await api.get("/bookings/technician/my");
  ...
  const renderBookingCard = (booking, history = false) => (
    <div
  ...
  return (
    <div className="technician-my-bookings">
      ...
      {!loading && historyBookings.length > 0 && (
        <div className="my-bookings-section booking-history-section">
